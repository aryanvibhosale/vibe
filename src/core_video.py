...
# from .model.voxcpm import VIBETextToMusic, LoRAConfig
from model.vibe_v2m import VIBEVideo2Music, LoRAConfig
...
class VIBEVideo:
    def __init__(self,
        ...
        self.tts_model = VIBEVideo2Music.from_local(voxcpm_model_path, 
                                                optimize=optimize, 
    ...
    def _generate(self, 
        ...
        try:
            ...
            for wav in generate_result:
                yield wav["audio"].squeeze(0).cpu().numpy()
